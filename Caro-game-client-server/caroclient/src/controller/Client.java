...
public class Client {
    ...
    public void initView(){
        ...
        new Thread(socketHandle).start();   // ✔ chạy socket trên thread riêng

        // ✔ ShutdownHook phải đặt NGAY SAU khi thread socket được start
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            try {
                if (Client.socketHandle != null && Client.user != null) {
